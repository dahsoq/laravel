 ...
 <div style = 'text-align:center;'>
    ...
    <div class="ffrs">
        @foreach ($recipes as $recipe)
            <div class="recipe1">
                <img class="recipeimg" src="{{ asset(str_replace('public/', '', $recipe->imgpath)) }}" alt="{{ $recipe->name }}">
    ...
    <div class="overlay" id="recipeOverlay" >
        <div class="modal">
            ...
            <div class="modalcookandtime">
                <div class="modalcook"><img src="/Image/icon-park-outline_pot.svg"><span id="modalServings"></span> порции</div>
